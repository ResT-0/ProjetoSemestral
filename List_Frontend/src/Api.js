...
export async function username(user) {
  return fetchData(`${API_URL}/user/${user}`);
}

export async function createList(task, userId) {
...
export async function updatelist(taskId, task) {
...
export async function deleteList(taskId) {
  return fetchData(`${API_URL}/tasks/${taskId}`, {
    method: "DELETE",
  });
}
